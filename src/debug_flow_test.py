...
logger = logging.getLogger("debug_flow_test")
...
try:
    ...
    # Import directly from the package without the src prefix
    from ai_interface.agents.tutor_agent import TutorAgent
    from ai_interface.shared_state import SharedState
...
def main():
    try:
        ...
        # Set mock topics (same as in debug_topic_selection.py)
